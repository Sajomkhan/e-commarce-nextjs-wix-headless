    ...
    <div className="h-[calc(100vh-var(--nav-height))]">
      ...
      >
        {slides.map((slide) => (
          ...
          >
            {/* ==============TEXT CONTAINER============== */}
            <div className="h-1/2 w-full xl:w-1/2 xl:h-full flex flex-col items-center justify-center gap-8 2xl:gap-12 text-center px-6">
      ...
      <div className="absolute m-auto left-1/2 bottom-8 flex gap-4">
        {slides.map((slide, index) => (
          ...
          >
            {current === index && (
              <div className="w-[6px] h-[6px] bg-gray-800 rounded-full"></div>
            )}
          </div>
        ))}
      </div>
